  ...
  <section id="contact" className="py-28 px-6 lg:px-8 border-t border-border/60">
    <div className="mx-auto max-w-[860px]">
      ...
      <AnimatedSection delay={0.3}>
        <div className="mt-8 p-6 md:p-8 rounded-xl border border-border/60 bg-card">
          <p className="text-[11px] font-medium tracking-widest uppercase text-muted-foreground/50 mb-4">
            github activity
          </p>
          <a
          ...
          >
            <img
              src="https://ghchart.rshah.org/10b981/Adityaakr"
              alt="GitHub contribution chart"
              className="w-full rounded-lg opacity-80 hover:opacity-100 transition-opacity duration-300 dark:invert dark:opacity-60 dark:hover:opacity-80"
            />
          </a>
